...
public struct Entry : IFlatbufferObject
{
  ...
  public string Term { get { int o = __p.__offset(4); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTermBytes() { return __p.__vector_as_span<byte>(4, 1); }
#else
  public ArraySegment<byte>? GetTermBytes() { return __p.__vector_as_arraysegment(4); }
#endif
  public byte[] GetTermArray() { return __p.__vector_as_array<byte>(4); }
  public schema.Etymology? Etymologies(int j) { int o = __p.__offset(6); return o != 0 ? (schema.Etymology?)(new schema.Etymology()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int EtymologiesLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  public static void StartEntry(FlatBufferBuilder builder) { builder.StartTable(2); }
  public static void AddTerm(FlatBufferBuilder builder, StringOffset termOffset) { builder.AddOffset(0, termOffset.Value, 0); }
  public static void AddEtymologies(FlatBufferBuilder builder, VectorOffset etymologiesOffset) { builder.AddOffset(1, etymologiesOffset.Value, 0); }
